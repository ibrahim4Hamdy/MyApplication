...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val but_0:Button   =findViewById(R.id.but_0)
        val but_1:Button   =findViewById(R.id.but_1)
        val but_2:Button   =findViewById(R.id.but_2)
        val but_3:Button   =findViewById(R.id.but_3)
        val but_4:Button   =findViewById(R.id.but_4)
        val but_5:Button   =findViewById(R.id.but_5)
        val but_6:Button   =findViewById(R.id.but_6)
        val but_7:Button   =findViewById(R.id.but_7)
        val but_8:Button   =findViewById(R.id.but_8)
        val but_9:Button   =findViewById(R.id.but_9)
        val but_plus:Button   =findViewById(R.id.but_plus)
        val but_minus:Button   =findViewById(R.id.but_minus)
        val but_multi:Button   =findViewById(R.id.but_multi)
        val but_divide:Button   =findViewById(R.id.but_divide)
